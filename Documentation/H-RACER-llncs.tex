...
\newpage
\section{\label{chap:1}Introduction}
%
...
\\
\\
This thesis documentation is organized as follows; illustrating some basics about deoxyribonucleic acid (DNA), deoxyribonucleic acid (DNA) sequencing, next-generation sequencing (NGS), and next-generation sequencing (NGS) errors correction in chapter \ref{chap:1}, while the  existing methodologies for error correction are demonstrated in chapter \ref{chap:2}, then the first proposed algorithm is demonstrated and evaluated in chapter \ref{chap:3}, while the second proposed algorithm is demonstrated in chapter \ref{chap:4}. In chapter \ref{chap:5}, a comparison is set between the new methodology of the second proposed algorithm versus the existent ones through experimental data. The conclusion and future work are shown in chapter \ref{chap:6}.
%
...
\begin{figure}
	...
	\begin{subfigure}{.5\textwidth}
		...
		\label{fig:subfig2}
	\end{subfigure}
	\caption[caption]{DNA scientific analysis}
\end{figure}
...
\begin{figure}
	...
	\label{fig:fig2}
	\caption[caption]{DNA sequencing}
\end{figure}
...
\begin{figure}
	...
	\label{fig:fig3}
	\caption[caption]{DNA sequencing - Gene example}
\end{figure}
...
Early FASTQ uses PHRED quality score (which is a measure of the quality of the identification of the nucleobases generated by automated DNA sequencing where it is logarithmically linked to error probabilities as illustrated below in figure 6). Storing PHRED scores as single characters (or bytes) gave a simple but reasonably space efficient encoding. In order that the file be human readable and easily edited, this restricted the choices to the ASCII printable characters 32–126 (decimal), and since ASCII 32 is the space character, ASCII 33–126 is used instead to encode PHRED qualities from 0 to 93 (i.e. PHRED scores with an ASCII offset of 33).
...
\newpage
\subsubsection{NGS Sequences Errors Correction}
...
\begin{figure}
	...
	\label{fig:debruijn}
	\caption[caption]{\textbf{De Bruijn Graph} - k-mer of length 7}
\end{figure}
%
\newpage
\section{\label{chap:2}Related Work}
...
\subsubsection{Parallel Error Correction with CUDA}
...
They are algorithms that are able to correct all types of DNA reads errors, these algorithms are: Coral \cite{Coral}, HSHREC \cite{HShrec}, and Pollux \cite{Pollux}. Check figure 15.
...
\newpage
\section{\label{chap:3}The First Proposed Algorithm}
...
\begin{figure}
	...
	\label{fig:fig13}
	\caption[caption]{First Proposal Diagram}
\end{figure}

\subsection{Evaluation}
\subsubsection{Datasets and Platform}
...
\begin{longtable}{|m{22.5mm}|m{17.5mm}|m{19.5mm}|m{14.5mm}|m{10.5mm}|m{14.5mm}|m{14mm}|}
	    \caption{\label{tab:eval1-data}Data sets used in evaluation} \\
        \hline
...
The comparisons, shown below in tables \ref{tab:eval1-1}, were established between H-RACER and algorithms specialized in correcting all types of errors (substitutions, insertions, and deletions). While the obtained measurements were brought via the verification code implemented by RACER, that has the advantage of avoiding the interference of mapping or assembling programs. 
\\\\
...
\begin{longtable}{|m{33mm}|m{20mm}|m{20mm}|m{20mm}|m{20mm}|}
	    \caption{\label{tab:eval1-1}Evaluation comparison table for Lactococcus Lactis}\\
        \hline
...
\newpage
\section{\label{chap:4}The Second Proposed Algorithm}
...
\begin{figure}
	\centering
	\includegraphics[width=.911\linewidth]{./figs/Second-Proposal-1}
	\label{fig:fig13}
	\caption[caption]{H-Racer Flow Chart}
\end{figure}
...
\newpage
\section{\label{chap:5}Evaluation}
...
\newpage
\section{\label{chap:6}Conclusion and Future Work}
